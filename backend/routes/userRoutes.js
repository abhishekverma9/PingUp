...
import { allUsers, forgotPassword, getFriendProfileData, getProfileData, getSessions, googleLogin, loginUser, logoutAllDevices, logoutUser, refreshAccessToken, registerUser, resetPassword, revokeSession, updatePassword, updateProfileData, getUserIdByUsername } from '../controllers/userController.js'
...
userRouter.get('/username/:username', authUser, getUserIdByUsername)
